...
function GameSite:ctor(config)
    ...
    self.apos = VectorUtil.newVector3(tonumber(config.ax), tonumber(config.ay), tonumber(config.az))
    self.ayaw = tonumber(config.ayaw)
    self.bpos = VectorUtil.newVector3(tonumber(config.bx), tonumber(config.by), tonumber(config.bz))
