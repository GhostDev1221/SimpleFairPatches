...
function MerchantConfig:initExchangePosition(exchangePosition)
    self.exchangePosition = VectorUtil.newVector3(tonumber(exchangePosition[1]), tonumber(exchangePosition[2]), tonumber(exchangePosition[3]))
end
...
function MerchantConfig:initStores(stores)
    ...
    for i, v in pairs(stores) do
        local store = {}
        store.initPos = VectorUtil.newVector3(tonumber(v.initPos[1]), tonumber(v.initPos[2]), tonumber(v.initPos[3]))
