...
function GamePlayer:changeModel()
    ...
    if self.changeModelTimes == 0 then
        ...
        if self.dynamicAttr.pioneer then
            ...
            self.clientPeer:buyChangeActor(false, self.changeModelTimes + 1, price.blockmanPrice)
        end
    end
end
...
function GamePlayer:showChangeModel()
    ...
    if self.changeModelTimes == 0 then
        ...
        if self.dynamicAttr.pioneer then
            ...
            self.entityPlayerMP:setChangePlayerActor(false, self.changeModelTimes + 1, price.blockmanPrice, self.model.actor)
        end
    end
end
...
function GamePlayer:onUseArrow()
    ...
    if player then
        HostApi.createArrowTipMark(self.rakssid, self:getPosition(), player:getPosition(), 5, 5)
    end
end
