...
function HouseConfig:buildHouse(manorIndex, currentHouseId)
    ...
    EngineWorld:getWorld():createOrDestroyHouseFromSchematic(filePath, startPosition, false, false, true)
...
function HouseConfig:destroyHouse(manorIndex, currentHouseId)
    ...
    if filePath ~= nil and startPosition ~= nil then
        EngineWorld:getWorld():createOrDestroyHouseFromSchematic(filePath, startPosition, false, false, false)
    else
