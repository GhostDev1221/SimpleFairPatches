...
function GameDomain:onCreate(basicId)
    ...
    EngineWorld:getWorld():createOrDestroyHouseFromSchematic(self.config.baseFileName, pos, xImage, zImage, true)
    self:onPrepare()
end
...
function GameDomain:onRemoveOccMeta()
    ...
    EngineWorld:getWorld():createOrDestroyHouseFromSchematic(self.config.fileName, pos, xImage, zImage, false)
end
