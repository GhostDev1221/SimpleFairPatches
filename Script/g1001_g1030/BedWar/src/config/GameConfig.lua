...
GameConfig.storeUpgradeId = 0
GameConfig.ironUpgradeId = 0
GameConfig.goldUpgradeId = 0
...
function GameConfig:init()
    ...
    self.storeUpgradeId = tonumber(tinyObj.storeUpgradeId)
    self.ironUpgradeId = tonumber(tinyObj.ironUpgradeId)
    self.goldUpgradeId = tonumber(tinyObj.goldUpgradeId)
    ...
    MoneyConfig:initPublicMoney(tinyObj.publicMoney)
