...
function AirplaneConfig:randomCenterPoint(centerPoint)
    ...
    return VectorUtil.newVector3(tonumber(x), tonumber(y), tonumber(z))
end
...
function AirplaneConfig:getEndPoint(startPoint, centerPoint)
    ...
    return VectorUtil.newVector3(tonumber(math.ceil(x)), tonumber(math.ceil(y)), tonumber(math.ceil(z)))
end
