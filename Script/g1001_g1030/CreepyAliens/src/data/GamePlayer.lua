...
function GamePlayer:initDataFromDB(data)
    if #data ~= 0 then
        ...
        self.arms = json_data.arms or {}
        self.equipment = json_data.equipment
        self.exp = json_data.exp or 0
        self.isGoldAddition = json_data.isGoldAddition or false
        self.isExpAddition = json_data.isExpAddition or false
        self.isSpeedAddition = json_data.isSpeedAddition or false
    end
    self:initPlayer()
end
...
function GamePlayer:buildShowName()
    ...
    -- pureName line
    local disName = TextFormat.colorGold .. "[Lv" .. tostring(self.level) .. "]" .. TextFormat.colorWrite .. self.name
