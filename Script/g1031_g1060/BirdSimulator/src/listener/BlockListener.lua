...
function BlockListener.onBirdSimulatorAddGatherScore(userId, birdId, blockId, blockPos, score, maxStage, stage)
    ...
    TaskHelper.dispatch(TaskType.CollectFieldFruitEvent,player.rakssid, fieldId, fruitNum)
    TaskHelper.dispatch(TaskType.CollectFruitByNum,player.rakssid, fruitNum)
    TaskHelper.dispatch(TaskType.CollectFruitByColor,player.rakssid, fruitNum, colorId)
