...
function GamePlayer:initDataFromDB(data)
    if #data ~= 0 then
        ...
        self.guns = json_data.guns or {}
        self.hallMoney = json_data.money or 0
        self.teamId = json_data.teamId or 1
        self.gunSprayPaints = json_data.gunSprayPaints or {}
        self.specialClothing = json_data.specialClothing or {}
    end
    self:setPlayerTeam()
    self:initTeam()
    self:teleInitPos()
